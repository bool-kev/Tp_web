...
class Matiere(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("matiere.vue", kwargs={"matiere": self.slug})
...
class Cour(models.Model):
    ...
    file=models.FileField(upload_to='SchoolApp/static/Cours_file',null=True,blank=True)
    ...
    def get_absolute_url(self):
        return reverse("cour.vue", kwargs={"matiere": self.matiere.slug,"cours":self.slug})
